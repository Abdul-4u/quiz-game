...
int main()
    ...
    printf("\n >> In warmup round 5 questions and You will be eligible to play the ");
    printf("\n    game if you give atleast 3 right answers, otherwise you can't proceed");
    printf("\n    further to the Challenge Round.");
    printf("\n >> Your game starts with CHALLANGE ROUND. In this round you will be asked a");
    printf("\n    total of 10 questions. Each right answer will be awarded $1000,000!");
    ...
    system("cls");
     ...
     switch(r1)
		{
		case 1:
		printf("\n\nWhich of the following is FIBONACCI series?");
		printf("\n\nA.12345...\t\tB.13579...\n\nC.01123...\t\tD.02468...");
		if (toupper(getch())=='C')
			{
			    printf("\n\nCorrect!!!");count++;
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is C.01123...");
		           getch();
		       break;
		       }

        case 2:
		printf("\n\n\nHow many medal india won in Tokyo olympics 2021.");
		printf("\n\nA.3\t\tB.5\n\nC.7\t\tD.9");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");count++;
			getch();
...
void help()
    ...
    printf("\n    total 10 questions each right answer will be awarded $1,000,000.");
